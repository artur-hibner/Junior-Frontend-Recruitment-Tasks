...
// =============== MAIN TASKS ===============
    ...
    gulp.task('compile:prod', function() {
        ...
        console.log(color('======================================================================', 'MAGENTA'));
       gulp.start('html:prod', 'sass:prod');
    });
    ...
    gulp.task('dev', function() {
        ...
        console.log(color('======================================================================', 'YELLOW'));
        gulp.start('html:dev', 'sass:dev', 'browsersyncDev', 'watch:dev');
    });
    ...
    gulp.task('prod', function() {
        ...
        console.log(color('======================================================================', 'RED'));
        gulp.start('html:prod', 'sass:prod', 'browsersyncProd', 'watch:prod');
    });
